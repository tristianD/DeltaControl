...
Kinematics Kine;
AccelStepper stepperX(1, PB9, PC0, PC1);  //STEP DIR ENA
AccelStepper stepperY(1, PB7, PB8, PC1);
AccelStepper stepperZ(1, PB5, PB6, PC1);
...
{
    int pulse_1 = 25600 * theta1 / 360;
    int pulse_2 = 25600 * theta2 / 360;
    int pulse_3 = 25600 * theta3 / 360;
...
void Robot_Control :: Calib_home()
{
    ...
    stepperZ.setSpeed(20000);

    stepperX.setCurrentPosition(0);
    stepperY.setCurrentPosition(0);
    stepperZ.setCurrentPosition(0);
    GetPosition(34, 34, 34);
    stepperX.setCurrentPosition(0);
    stepperY.setCurrentPosition(0);
    stepperZ.setCurrentPosition(0);
}
...
// startTime = micros();
    long gotoposition[3];
    gotoposition[0] = 25600 * theta1 / 360;
    gotoposition[1] = 25600 * theta2 / 360;
    gotoposition[2] = 25600 * theta3 / 360;
